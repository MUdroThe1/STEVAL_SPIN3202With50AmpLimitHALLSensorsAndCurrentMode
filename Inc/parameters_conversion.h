...
#define SPEED_TIMER_CONV_FACTOR             (uint32_t) (10 * (HALL_TIM_CLK / (POLE_PAIR_NUM * U_RPM / SPEED_UNIT)))
...
#define CURRENT_MONITOR_CONV_FACTOR         (uint32_t) ((1000 * ADC_REFERENCE_VOLTAGE) / (RSHUNT * AMPLIFICATION_GAIN))
#define M1_CUR_MON_SAMPLING_CONV            (uint16_t) (1.2 * (SYSCLK_FREQ/1000) * TIM_CLOCK_DIVIDER / 1000)
...
#define M1_HALL_IC_FILTER_LL LL_TIM_IC_FILTER_FDIV1
#define M1_HALL_IC_FILTER   LL_TIM_IC_FILTER_FDIV1
